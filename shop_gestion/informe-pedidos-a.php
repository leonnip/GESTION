                ...
                <div class="tab_container">                	                    
                    ...
                    <div id="tab1" class="tab_content">
                        ...
                        <div id="resultSearch">
                            ...
                            <div id="dvData0">
                        	<table id="resultSearch_Opt" cellpadding="1" cellspacing="1" bordercolor="#666666" style="border-collapse:collapse;" >
                            	<thead>
    	                    ...
    	                    <script type="text/javascript">
							    ...
							    function drawChart() {
						          ...
						          ['Facturación Total',      <?php echo $_factTotal; ?>, <?php echo $_devolTotal; ?> ],
								  ['Devoluciones Total', <?php echo $subtotal-$comision; ?>, 0 ],
						          ['Comisión el País',      <?php echo $comision; ?>, 0 ],
								  ['Dev. Comisión el País',      <?php echo $comision; ?>, 0 ]
						        ]);
                        ...
                        <div id="resultSearch">
                        	...
                        	<table id="resultSearchCompleto" cellpadding="1" cellspacing="1" class="tablaExcel1">
                                ...
                                <?php
									...
									<tbody id="dataCustomer">                                
        	    	                    ...
        	    	                    <tr><td colspan="15" height="24px"></td></tr><tr><td colspan="15" height="24px"></td></tr>
            	    	                <tr><td colspan="15" height="24px"></td></tr><tr><td colspan="15" height="24px"></td></tr>
            	    	                <tr><td colspan="15" height="24px"></td></tr>                        	                          	                    
                            	    </tbody>';
									}
								?>	                                							
                            </table>
                            ...
                            <table style="width: 400px" cellpadding="0" cellspacing="0" style="margin-top: 20px; border: 1px solid #ccc" >
                                ...
                                <tbody>
                                    ...
                                    <tr height="22px"><td><label>Comisión Prensa</label></td><td><label><?php echo number_format($_cuadroComision,2,',','.') ?> &euro;</label></td></tr>
                                    <tr height="22px"><td><label style="color:#F00">Devoluciones y No Entregados</label></td><td><label style="color:#F00"><?php echo number_format($_cuadroDevolFact,2,',','.') ?> &euro;</label></td></tr>
                                    <tr height="22px"><td><label style="color:#F00">Comisión Prensa Devoluciones</label></td><td><label style="color:#F00"><?php echo number_format($_cuadroDevolComision,2,',','.') ?> &euro;</label></td></tr>
                                    <tr height="25px">
                                    	<td bgcolor="#1F88A7"><label style="color:#fff; font-size: 1.2em">aportacion Neta Total</label></td>
                                        <td bgcolor="#1F88A7"><label style="color:#fff; font-size: 1.2em"><?php echo number_format(($_aportBruta - $_aportDevolBruta) - ($_cuadroComision - $_cuadroDevolComision),2,',','.'); ?> &euro;</label></td>
                                    </tr>
                                </tbody>
                            </table>
						    ...
						    <script type="text/javascript">
								...
								function drawChart() {
								    var data = google.visualization.arrayToDataTable([
										...
										['Aportación Neta', <?php echo ($_aportBruta - $_aportDevolBruta) - ($_cuadroComision - $_cuadroDevolComision); ?>,0  ]
									]);
