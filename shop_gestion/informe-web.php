	                        	...
	                        	<table id="resultSearch_Opt" cellpadding="1" cellspacing="1">
									...
									if (isset($_POST['consultar'])) {									
										...
										for($i=$fechaInicio; $i<=$fechaFin; $i+=86400){	
											...
											$SQL .= "WHERE ordenes.FechaOrden >= '$fechaff' AND FechaOrden <= '$fechaff' AND ordenes.EstadoPago = 'ok' AND ordenes.Tramitado = 'usuario-web' ";
											$SQL .= "AND (ordenes.FormaPago = 'contra-rembolso' OR ordenes.FormaPago = 'tarjeta' OR ordenes.FormaPago = 'paypal') AND TRIM(lineasorden.EstadoPedido) <> 'Anulado' ";
											$SQL .= "UNION ";
											...
											$SQL .= "AND TRIM(ordenes.Tramitado) = 'usuario-web' AND (ordenes.FormaPago = 'contra-rembolso' OR ordenes.FormaPago = 'tarjeta' OR ordenes.FormaPago = 'paypal') AND TRIM(lineasorden.EstadoPedido) <> 'Anulado'";
										...
										<tbody id="dataCustomer">
											<tr><td colspan="5" height="24px"></td></tr><tr><td colspan="5" height="24px"></td></tr>
	                	        	        <tr><td colspan="5" height="24px"></td></tr><tr><td colspan="5" height="24px"></td></tr>
    	                	                <tr><td colspan="5" height="24px"></td></tr><tr><td colspan="5" height="24px"></td></tr>
        	                	       	    <tr><td colspan="5" height="24px"></td></tr><tr><td colspan="5" height="24px"></td></tr>
            	                	       	<tr><td colspan="5" height="24px"></td></tr><tr><td colspan="5" height="24px"></td></tr>                	                    
