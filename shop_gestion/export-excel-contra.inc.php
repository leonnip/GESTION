...
<?php
    ...
    header("Content-Disposition: attachment; filename=C_ordenes_".$date.".xls");
	...
	$thead = '<table border="1" bordercolor="#CCCCCC" cellpadding="10" cellspacing="10">
   		<tr height="30px">
			...
			<td bgcolor="yellow" valign="middle" style="text-align:center; width:100px;font-weight: bold; font-size:13px;">OBSERVACIONES</td>
	...
	for ($index=0; $index <= $cont-1; $index++) {
		...
		echo '
			<tr>
				...
				<td style="font-size:12px;text-align:center">'.$pedidos[$index]['idorden'].$_SESSION['TPV_ORDEN'].'</td>
