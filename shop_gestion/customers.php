    ...
    <div id="content-body">
    	<div id="general" class="content">
        	<div id="Contenido" style="padding-top: 20px; overflow: auto; overflow-x:hidden">   
            	...
            	<ul class="tabs">
    		    	<li class="active"><a href="#tab1"><span>Operaciones Clientes</span></a></li>
		   			<li><a href="#tab2">Estado Pedidos</a></li>
                ...
                <div class="tab_container">                	                    
                    ...
                    <div id="tab1" class="tab_content">
                    	<div id="busquedaClientes">	
                        	<div class="fieldset">
	                        	...
	                        	<form id="formCustomer" name="formCustomer" method="post" action="search-customer-operation.inc.php?idbd=" . <?php echo $_GET['idbd']; ?> accept-charset="utf-8" enctype="multipart/form-data">
                	...
                	<div id="tab2" class="tab_content">
                    	<div id="busquedaClientes">	
                        	<div class="fieldset">
                            	<h2 class="legend">Información personal</h2>
	                        	<form id="formCustomerEst" name="formCustomerEst" method="post" action="search-customer-estados.inc.php?idbd=" . <?php echo base64_decode($_GET['idbd']); ?> accept-charset="utf-8" enctype="multipart/form-data">
		                        	<table style="width:80%;">
    		                        	<thead>
        		                        	<th><label class="cab">Criterio</label></th>
            		                        <th><label class="cab">Filtro a aplicar</label></th>
                        		        ...
                        		        <tbody>
                            		    	<tr>
                                		    	<td>
                                    		    	<select id="criterioEst" name="criterioEst" data-placeholder="Seleccione Criterio" class="chosen-select" style="width: 200px">
                                            	    	<option value="0"></option>
                                                		<option value="idorden">Número de Orden</option>
                                                    	<option value="dni">Identificación</option>
	                                                    <option value="destinatario">Nombres</option>
	                	                        ...
	                	                        <td>
    	                	                    	<input type="text" id="filtroEst" name="filtroEst" style="width: 350px" autocomplete="off" />
        	                	                </td>
                                	            <td>
                                    	        	<input type="submit" id="buscar" name="buscar" value="Buscar Cliente" />                                                    
                                        	    </td>
                        ...
                        <div id="resultSearch">
                        	<h3><img src="images/result.png" style="float: left;" />&nbsp;Resultados</h3>
                        	<table id="resultSearch2" cellpadding="0" cellspacing="0">
                            	<thead>
                                	<th width="40px"></th>
           							<th width="60px">IdOrden</th>
                        ...
                        <table style="position: absolute; bottom: 75px; width: 100%;">
                    	    <tr>
                	           	<!--<td><img src="images/lupa.png" />&nbsp;Ver Pedido</td>-->    
            	                <td width="100px"><label class="ver"></label>&nbsp;<label>Ver Pedido</label></td>    
        	                    <td width="100px"><label class="imprimir"></label>&nbsp;<label>Cartel</label></td>
    	                        <td width="100px"><label class="modificar"></label>&nbsp;<label>Modificar</label></td>
	                            <td width="100px"><label class="cambiar"></label>&nbsp;<label>Dirección</label></td>
                        ...
                        <div id="green3" style="margin: auto; position: absolute; bottom: 20px;"></div>						                       
