    ...
    <div id="content-body">
    	<div id="general" class="content">
        	<div id="Contenido" style="padding-top: 20px; overflow: auto; overflow-x:hidden"> 
            	...
            	<ul class="tabs">
    		    	<li class="active"><a href="#tab1"><span>Informe Ventas Provincias</span></a></li>
                ...
                <div class="tab_container">                	                    
                    ...
                    <div id="tab1" class="tab_content">
                        ...
                        <div id="resultSearch">
                        	<h3><img src="images/result.png" style="float: left;" />&nbsp;Informe Ventas Provincias <?php echo $nombre; ?></h3><br />
                            <div id="dvData0">
	                        	<table id="resultSearch_Opt" cellpadding="1" cellspacing="1">
                            		...
                            		<thead>
                                		<th width="120px">Código Provincia</th>                                    
                                    	<th width="300px">Nombre provincia</th>
									...
									if (isset($_POST['consultar'])) {									
										...
										$SQL = "SELECT IFNULL(provincias.IdProv,0) AS CodProv, IFNULL(provincias.Provincia, 'Mal Asignado') AS Provincia, COUNT(DISTINCT(ordenes.IdOrden)) AS totalOrdenes, IFNULL(SUM(lineasorden.Cantidad), 0) AS totalProductos 
												FROM ordenes
												...
												LEFT JOIN provincias ON provincias.IdProv = direcciones.IdProvincia
												WHERE lineasorden.EstadoPedido <> TRIM('Anulado') AND ordenes.EstadoPago = TRIM('ok') AND FormaPago <> TRIM('--') AND ordenes.FechaOrden >= '$fecha1' AND ordenes.FechaOrden <= '$fecha2' 
												GROUP BY provincias.IdProv";
										...
										foreach($result as $result1) {																		
											echo '
												<tr height="24px">
													<td><label>'.$result1->CodProv.'</label></td>												
													<td><label>'.utf8_encode($result1->Provincia).' '.utf8_encode($result1->Apellidos).'</label></td>
											...
											$graph[] = array("provincia"=>$result1->Provincia, "ordenes"=>$result1->totalOrdenes, "productos"=>$result1->totalProductos);								
										}
							    	    ...
							    	    var data = google.visualization.arrayToDataTable([
							    	      ['Informe', 'Ordenes', 'Productos'],											  
										   <?php for($i=0; $i<=$totalGraph-1; $i++) {
											echo "['".utf8_encode($graph[$i]['provincia'])."',".$graph[$i]['ordenes'].",".$graph[$i]['productos']."],";
										   } ?>										 	
						        		]);
