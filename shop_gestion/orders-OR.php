...
<div id="wrapper" class="wrapper">
    ...
    <div id="TopBar" class="iluminacion">	
        <?php 
			...
			require_once('ordenes-producto.inc.php');
			require_once('ordenes-por-fechas.inc.php');
			...
			# FUNCION PARA REDUDIR LA IMAGEN
			# =============================================================
                ...
                <div class="tab_container">                	                    
                    ...
                    <div id="tab1" class="tab_content">
                        ...
                        <div id="resultSearch">
                            ...
                            <div id="frm">
                            <form id="form-cambiar-estadosC" name="form_cambiar_estadosC" data-title="group_1" method="post" action="cambiar-estados.orders.inc.php?idbd=" enctype="application/x-www-form-urlencoded">
        		                        ...
        		                        <tbody id="dataCustomerOrder">
            		                    	<?php
												...
												if (mysqli_num_rows($row) > 0) {
													...
													//foreach($result as $result1) {
														/*
														$fullname = $result1->BaseUrl . $result1->Imagen;
														...
														$f = fopen($fullname, "r");
														$imagenData = fread($f, $imageSize);
														fclose($f);
														
														$r = new ImageResizer();
														$newImage = $r->resize($imagenData, 160, 120, 70, 'jpg', $ow, $oh);
														...
														*/
														...
														<tr>
															...
															<td height="24px">
																<a class="tooltip-css" data-title="">
																	<label class="date_fecha">'.$result1->FechaOrden.' | '.$result1->Hora.'</label>
																</a>
															</td>
                            ...
                            <table>
                            	<tr>
                                	<td align="center">
                                    	<form action="export-excel-contra.inc.php?idbd=<?php echo $_REQUEST['idbd']; ?>" method="post" enctype="application/x-www-form-urlencoded">
                            ...
                            <div id="frm">
                            <form id="form-cambiar-estadosT" name="form_cambiar_estadosT" method="post" data-title="group_2" action="cambiar-estados.orders.inc.php?idbd=" . <?php echo base64_decode($_GET['idbd']); ?> enctype="application/x-www-form-urlencoded">
                            <input type="hidden" id="listados" name="listados" value="0" />
                            <input type="hidden" id="idofertaList" name="idofertaList" value="0" />
                            <fieldset id="group_2">
                            	<table id="resultSearch_Opt" cellpadding="0" cellspacing="0">
                            ...
                            <table>
                            	<tr>
                                	<td align="center">
                                    	<form action="export-excel-tarjeta.inc.php?idbd=<?php echo $_REQUEST['idbd']; ?>" method="post" accept-charset="utf-8" enctype="application/x-www-form-urlencoded">
                	...
                	<div id="tab2" class="tab_content">
                    	<div id="busquedaClientes">	
                        	<div class="fieldset">
	                        	...
	                        	<form id="formPedidosFecha" name="formPedidosFecha" class="loading" method="post" action="orders.php?idbd=" . <?php echo base64_decode($_GET['idbd']); ?> accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div id="tab3" class="tab_content">
                    	<div class="busquedaClientes">
                        	<div class="fieldset">
                            	<h2 class="legend">Rango de Fechas</h2>
	                        	<form id="formPedidosOferta" name="formPedidosOferta" class="loading" method="post" action="orders.php?idbd=" . <?php echo base64_decode($_GET['idbd']); ?> accept-charset="utf-8" enctype="multipart/form-data">
		                        	<table style="width:40%">
    		                        	<thead>
        		                        	<th><span style="font-size:15px; font-variant: small-caps; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">Fecha Inicio</span></th>
            		                        <th><span style="font-size:15px; font-variant: small-caps; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">Fecha Fin</span></th>
                    ...
                    <div id="tab4" class="tab_content">    
                    	...
                    	<div id="busquedaClientes">	
                        	<div class="fieldset">
                            	<h2 class="legend">Rango de Fechas</h2>
	                        	<form id="formPedidosUsser" name="formPedidosUsser" class="loading" method="post" action="orders.php?idbd=" . <?php echo base64_decode($_GET['idbd']); ?> accept-charset="utf-8" enctype="multipart/form-data">
		                        	<table style="width:40%">
    		                        	<thead>
        		                        	<th><span style="font-size:15px; font-variant: small-caps; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">Fecha Inicio</span></th>
            		                        <th><span style="font-size:15px; font-variant: small-caps; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">Fecha Fin</span></th>
